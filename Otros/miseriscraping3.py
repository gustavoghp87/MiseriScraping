...
print("\n\n\n\n            ######## BUEN DÍA ESTIMADO/A! ######## \n               ### ESTO ES MISERISCRAPING 3 ### \n\n\nEsta versión consume archivo Excel con la totalidad del territorio y hace el resto. Enjoy it.-\n")
...
for k in range(1, 57):
	...
	print("\n\n########           COMENZANDO TERRITORIO " + str(terri_elegido) + "               ###################################")
		...
		if territorio == terri_elegido:
			...
			for i in range(min, max+1):
				...
				for j in range(1, 10):
					...
					if contador1 != 0 and contador1%15 == 0:
						unoMas = "si"
					else:
						unoMas = "no"
					print("Uno más: " + unoMas)
